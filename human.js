...
//налакътник
var geometry = new THREE.CylinderGeometry(1.35, 1.35, 4, 64);
var material = new THREE.MeshPhongMaterial({ color: "pink" });
var neshto = new THREE.Mesh(geometry, material);
neshto.position.y = -8;

var neshto1 = new THREE.Mesh(geometry, material);
neshto1.position.y = -8;

//лента на глезена
var geometry = new THREE.CylinderGeometry(1.3, 1.3, 3, 64);
var neshto2 = new THREE.Mesh(geometry, material);
neshto2.rotation.z = Math.PI / 2;
neshto2.position.x = 3;

var geometry = new THREE.CylinderGeometry(1.3, 1.3, 3, 64);
var neshto3 = new THREE.Mesh(geometry, material);
neshto3.rotation.z = Math.PI / 2;
neshto3.position.x = 3;

//лента за глава
var geometry = new THREE.CylinderGeometry(3.5, 3.5, 1, 64);
var neshto4 = new THREE.Mesh(geometry, material);
neshto4.position.y = 4.7;
